...
var Mochito = {
	...
	contactOpt: function() {
		...
		options.click(function(e){
			...
			if ( item.data("id") === 1) {
				$("#form-contact .hide").css({visibility: 'visible'});
				$("#form-contact .hide").animate({height: '52px'}, 300);
				$tis.formType = 1;
			} else {
				$("#form-contact .hide").animate({height: '0px'}, 300, function(){
					$("#form-contact .hide").css({visibility: 'hidden'});
				});
				$tis.formType = 0;
			}
